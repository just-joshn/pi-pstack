...
Set the completed user-facing feature map path in `control.feature_map_path`. Copy and fill [`feature-map.example.md`](references/feature-map.example.md) outside `.pi/automations/benny/` instead of editing the copied example.
