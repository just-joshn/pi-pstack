...
2. **Scope.** Present the user with these options:
   ...
   - **User**: `${PI_CODING_AGENT_DIR:-$HOME/.pi/agent}/skills/<name>/SKILL.md` in Pi's agent directory (`$PI_CODING_AGENT_DIR`, default `~/.pi/agent`). Available in all projects.
