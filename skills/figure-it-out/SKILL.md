...
Open a todo list whose first item is to read the Principles section of the **poteto-mode** skill. On Pi, use the `todo` tool. Then add the phases below as todos.
