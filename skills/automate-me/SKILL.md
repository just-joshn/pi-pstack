...
This skill orchestrates three others: an inline mining pass (see step 1), Cursor's built-in Pi skill authoring (authoring), and the **unslop** skill (prose discipline). It sequences them. It doesn't replace them.
